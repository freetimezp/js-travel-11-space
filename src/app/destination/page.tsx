...
const planets = [
    {
        ...
        distance: "384,400 km",
        time: "3 days",
        description: `See our planet as youвЂ™ve never seen it before. A perfect relaxing trip away to help regain perspective and come back refreshed. While youвЂ™re there, take in some history by visiting the Luna 2 and Apollo 11 landing sites.`,
    },
    {
        name: "Mars",
        image: mars,
        distance: "225,000 km",
        time: "9 months",
        description: `DonвЂ™t forget to pack your hiking boots. YouвЂ™ll need them to tackle Olympus Mons, the tallest planetary mountain in our solar system. ItвЂ™s two and a half times the size of Everest!`,
    },
    {
        name: "Europa",
        image: europa,
        distance: "628,000 km",
        time: "3 years",
        description: `The smallest of the four Galilean moons orbiting Jupiter, Europa is a winter loverвЂ™s dream. With an icy surface, itвЂ™s perfect for a bit of ice skating, curling, hockey, or simple relaxation in your snug wintery cabin.`,
    },
    {
        name: "Titan",
        image: titan,
